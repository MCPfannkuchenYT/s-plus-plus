...
public class SPlusPlus {
	...
	<text
			...
			/* Step 5: Save to /var/www/backend/pancake */
			Files.write(new File("/var/www/backend/pancake/stats.html").toPath(), innerHTML.getBytes(StandardCharsets.UTF_8), StandardOpenOption.CREATE);
